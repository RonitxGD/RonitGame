...
public class PlayerWeaponController : MonoBehaviour
{
    ...
    // Add audio clips for shooting and reloading
    [Header("Audio Clips")]
    ...
    private void Start()
    {
        ...
        audioSource = GetComponent<AudioSource>(); // Make sure there's an AudioSource attached to this GameObject
        AssignInputEvents();
    ...
    private void Shoot()
    {
        ...
        {
            // Play the fire audio until shooting stops
    ...
    private void Reload()
    {
        ...
        {
            // Play reload sound and continue until reload is done
